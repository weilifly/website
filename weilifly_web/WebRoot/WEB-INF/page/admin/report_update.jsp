...
<html>
	<head>
        ...
        KindEditor.ready(function(K) {    
			...
			var uploadbutton = K.uploadbutton({
				...
				fieldName : 'imgFile',
				url : '../myFileUpload.do?p=<%=des.encrypt("3,1,7,1,"
						+ ((Admin) session
	...
	<body>
		<s:form id="updateReport" action="updateReport.do" method="post">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<s:else>
										<img id="singImg" style="width: 150px; height: 150px" src="../${paramMap.image }" />
									</s:else>
									...
									<span class="require-field"> <s:textfield type="text"
											...
											id="image" name="paramMap.image" />(最佳分辨率 158x158px) <s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.seoTitle" theme="simple" id="seoTitle"
										cssStyle="width: 350px; height:23px;" />
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textarea name="paramMap.seoKeywords" theme="simple" id="seoKeywords"
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textarea name="paramMap.seoDescription" theme="simple" id="seoDescription"
										cssStyle="width: 450px; height:150px;" />
									<span style="color: red;">*<s:fielderror
