		...
		<script type="text/javascript">
			function deleteParameter(id,productId){
				if(window.confirm("确定删除？")){
					window.location.href = "deleteProductParameter.do?ids="+id+"&productId="+productId;
				}
			}
		</script>
	</head>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryProductParameterList.do?id=${paramMap.id }">产品参数列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addProductParameterInit.do?id=${paramMap.id }">添加产品参数</a>
							</td>
							<td>
								&nbsp;
							</td>
									...
									<s:else>
										<s:iterator value="#request.list" var="bean" status="st">
											<tr class="gvItem">
												...
												<td>
													<a href="updateProductParameterInit.do?id=${bean.id }" target="main">
														编辑 </a>&nbsp;
