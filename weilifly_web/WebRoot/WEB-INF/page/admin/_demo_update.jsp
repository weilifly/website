...
<html>
	...
	<body>
		<form id="updateDemo" name="updateDemo" action="updateDemo.do" method="post">
			<div id="right"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" align="center" bgcolor="#8594A9"
									class="white12">
									<a href="queryDemoInit.do">会员列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield id="tb_title" name="paramMap.nickName"
										cssClass="in_text_250" theme="simple"></s:textfield>
									<span class="require-field">*<s:fielderror fieldName="paramMap.nickName"></s:fielderror></span>
								</td>
							</tr>
