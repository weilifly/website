	...
	<head>
		...
		$(function(){
   		...
   		function initListInfo(praData) {
		    praData["storeName"] = $("#storeName").val();
		    praData["type"]=$("#type").val();
		    praData["status"] = $("#status").val();
	   		$.shovePost("queryWebDistribute.do",praData,initCallBack);
   		}
   		
   		//删除单个
   		function deleteWebDistributeById(adminIds,pageNow){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteWebDistribute.do?id="+adminIds+"&pageNow="+pageNow;
	 		}
   		}
   		...
   		//删除多个选中项
   		function deleteWebDistribute(pageNow){
   			if(!checked("删除")){
   				return;
   			}
			...
			Ids = Ids.substring(0,Ids.lastIndexOf(","));
		 	window.location.href = "deleteWebDistribute.do?id="+Ids+"&pageNow="+pageNow;
   		}
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									销售店铺：
									<input id="storeName" name="paramMap.storeName" />
									&nbsp;&nbsp;类型：
