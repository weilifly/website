...
<html>
	...
	<body>
		<s:form id="updateWebDistribute" action="updateWebDistribute.do"
			method="post">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:select name="paramMap.type" id="type" theme="simple"
										list="webDistributeTypeList" listKey="id" listValue="title"
										headerKey="-1" headerValue="-请选择-" value="paramMap.type">
									</s:select>
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<span class="require-field"><s:fielderror
											fieldName="paramMap.areaId"></s:fielderror> </span>
								</td>
							</tr>
							<tr>
								<td style="height: 25px;" align="right" class="blue12">
