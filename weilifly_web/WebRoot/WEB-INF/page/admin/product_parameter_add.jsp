		...
		<script type="text/javascript" language="javascript">
	    	...
	    	$(function(){
				...
				$("#btn_save").click(function(){
					var even = $(this);
					even.hide();
					param["paramMap.productId"] = "${paramMap.productId}";
					param["paramMap.parameterId"] = $("#parameterId").val();
					param["paramMap.content"] = editor_content.html();
					$.shovePost("addProductParameter.do",param,function(data){
					if(data.msg==1){
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									<s:select id="parameterId" theme="simple" name="paramMap.parameterId"
											list="#request.parameterList" listKey="id" listValue="name" headerKey="-1" headerValue="-请选择-">
									</s:select>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<textarea id="content" rows="15" class="textareash" style="width: 700px; padding:5px;" ></textarea>
								</td>
							</tr>
