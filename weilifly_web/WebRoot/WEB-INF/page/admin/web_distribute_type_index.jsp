...
<html>
  <head>
		...
		<script type="text/javascript" language="javascript">  		
	   		//删除单个
	   		function deleteWebDistributeTypeById(adminIds){
	   			if(window.confirm("此类型内容也会删除，确定要删除吗?")){
		 			window.location.href = "deleteWebDistributeType.do?id="+adminIds;
		 		}
	   		}
		</script>
  </head>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addWebDistributeTypeInit.do">添加网点分布类型</a>
							</td>
							<td>
								&nbsp;
							</td>
							...
							<s:else>
								<s:iterator value="#request.list" var="bean" status="st">
									<tr class="gvItem">
										...
										<td>
											<a href="updateWebDistributeTypeInit.do?id=${bean.id }" target="main"> 编辑</a>
											<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;" onclick="deleteWebDistributeTypeById(${bean.id })">删除</a>
										</td>
									</tr>
								</s:iterator>
							</s:else>
