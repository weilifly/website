		    ...
		    $(function(){
	   		...
	   		function initListInfo(praData) {
			    ...
			    praData["status"] = $("#status").val();
		   		$.shovePost("queryImgList.do",praData,initCallBack);
	   		}
	   		
	   		//删除单个
	   		function deleteImgListById(adminIds,pageNow){
		 		if(window.confirm("确定要删除吗?")){
		 			window.location.href = "deleteImgList.do?id="+adminIds+"&pageNow="+pageNow;
		 		}
	   		}
	   		...
	   		//删除多个选中项
	   		function deleteImgList(pageNow){
	   			if(!checked("删除")){
	   				return;
	   			}
				...
				Ids = Ids.substring(0,Ids.lastIndexOf(","));
			 	window.location.href = "deleteImgList.do?id="+Ids+"&pageNow="+pageNow;
	   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addImgListInit.do">添加图片列表</a>
							</td>
							<td>
								&nbsp;
							</td>
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									设计素材：
									<input id="title" name="paramMap.title" style="width:300px;" />
									&nbsp;&nbsp; 是否显示:
