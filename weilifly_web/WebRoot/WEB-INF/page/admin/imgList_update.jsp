...
<html>
		...
		<script type="text/javascript" language="javascript">
	    	...
	    	$(function(){
				...
				$("#btn_save").click(function(){
					...
					$.shovePost("updateImgList.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
  ...
  <body>
    <s:form id="updateImgList" action="updateImgList.do" method="post">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr id="trImg">
								...
								<td align="left" class="f66">
									...
									<span class="require-field"> <s:textfield type="text" name="paramMap.imgUrl"
							...
							<tr id="trLink" >
								...
								<td align="left" class="f66">
									<input class="in_text_2" id="downUrl" name="paramMap.downUrl" value="${paramMap.downUrl}" 
