...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript">  		
   		//删除单个
   		function deleteDesignCategoryById(adminIds){
	 		if(window.confirm("此分类列表也会删除，确定要删除吗?")){
	 			window.location.href = "deleteDesignCategory.do?id="+adminIds;
	 		}
   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryDesignCategoryOne.do">设计素材分类列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addDesignCategoryOneInit.do">添加设计素材分类</a>
							</td>
							<td>
								&nbsp;
							</td>
							...
							<s:else>
								<s:iterator value="#request.list" var="bean" status="st">
									<tr class="gvItem">
										...
										<td>
											<a href="updateDesignCategoryOneInit.do?id=${bean.id }"
												target="main"> 编辑</a>
											<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;"
												onclick="deleteDesignCategoryById(${bean.id })">删除</a>
										</td>
									</tr>
								</s:iterator>
							</s:else>
