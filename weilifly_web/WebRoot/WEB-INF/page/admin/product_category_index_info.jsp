	...
	<div>
		<table id="help" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<s:if test="#request.productCategoryList==null || #request.productCategoryList.size==0">
					<tr align="center" class="gvItem">
						<td colspan="10">暂无数据</td>
					</tr>
				</s:if>
				<s:else>
					<s:iterator value="#request.productCategoryList" var="bean" status="st">
						<tr class="gvItem">
							<td>
							...
							<td align="center">
								<img alt="" src="../${bean.image}" height="80px"/>
							</td>
							<td align="center">
							...
							<td>
								<a href="updateProductCategoryInit.do?id=${bean.id }" target="main">
								修改
								</a>
								&nbsp;&nbsp;
