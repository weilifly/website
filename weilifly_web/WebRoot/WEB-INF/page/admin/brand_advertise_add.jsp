		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("#btn_save").click(function(){
					...
					$.shovePost("addBrandAdvertise.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
							window.location.href = "queryBrandAdvertiseInit.do";
							return;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" align="center" bgcolor="#8594A9"
									class="white12">
									<a href="queryBrandAdvertiseInit.do">品牌广告列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" align="center" bgcolor="#CC0000" class="white12">
									<a href="addBrandAdvertiseInit.do">添加品牌广告</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<input class="in_text_2" id="path" readonly="readonly" name="paramMap.path"
