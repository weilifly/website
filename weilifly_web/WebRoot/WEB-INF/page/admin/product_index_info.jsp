				...
				<s:else>
					<s:iterator value="pageBean.page" var="bean" status="st">
						<tr class="gvItem">
							...
							<td align="center">
								<a href="queryProductParameterList.do?id=${bean.id}" style="color: blue;">参数管理</a>
							</td>
							<td align="center">
								<a href="queryProductDetailList.do?id=${bean.id}" style="color: blue;">详情管理</a>
							</td>
							<td align="center">
								${bean.sortIndex}
							</td>
							<td>
								<a href="updateProductInit.do?id=${bean.id }" target="main">
								修改
								</a>
								&nbsp;&nbsp;
