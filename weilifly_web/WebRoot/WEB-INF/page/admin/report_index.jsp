		...
		$(function(){
   		...
   		function initListInfo(praData) {
		    ...
		    praData["status"] = $("#status").val();
	   		$.shovePost("queryReport.do",praData,initCallBack);
   		}
   		
   		//删除单个
   		function deleteReportById(adminIds,pageNow){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteReport.do?id="+adminIds+"&pageNow="+pageNow;
	 		}
   		}
   		...
   		function deleteReport(pageNow){
			...
			Ids = Ids.substring(0,Ids.lastIndexOf(","));
		 	window.location.href = "deleteReport.do?id="+Ids+"&pageNow="+pageNow;
   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryReportInit.do">设计素材列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									&nbsp;&nbsp;分类：
									<s:select name="paramMap.categoryId" id="categoryId" theme="simple"
										list="reportCategoryList" listKey="id" listValue="name" headerKey="-1" headerValue="-请选择-">
									</s:select>
									&nbsp;&nbsp; 是否显示:
