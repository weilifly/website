		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("#btn_save").click(function(){
					...
					$.shovePost("addAdvertisement.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100" align="center" bgcolor="#CC0000" class="white12">
									<a href="addAdvertisementInit.do">添加App</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<input class="in_text_2" id="androidPath" name="paramMap.androidPath"
							...
							<tr>
								...
								<td align="left" class="f66">
									<input class="in_text_2" id="iosPath" name="paramMap.iosPath"
										type="text" style="width: 350px; height: 20px;" />
