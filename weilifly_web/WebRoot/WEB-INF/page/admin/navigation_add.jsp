...
<html>
		...
		<script type="text/javascript" language="javascript">
	    	$(function(){
				...
				$("#btn_save").click(function(){
					$(this).hide();
					$("#addNavigationBar").submit();
					return false;
				});	
			});
			function change(){
				var radio = this.document.getElementById('orderName');
				if(radio.value=='二级'){
					//
  ...
  <body>
    <form id="addNavigationBar" action="addNavigationBar.do" method="post">
			<div id="right"
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:select name="paramMap.orderName" id="orderName" theme="simple"
										list="#{'':'-请选择-','一级':'一级','二级':'二级'}" value="" onchange="change();">
									</s:select>
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:select id="order" list="orderList" name="paramMap.parentId" listKey="id" listValue="name" 
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.url" theme="simple"
										cssStyle="width: 200px; height:23px;" />
									<span style="color: red;">*<s:fielderror
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<span style="color: red;">*<s:fielderror
											fieldName="paramMap.enable" /> </span>
								</td>
							</tr>
							<tr>
								<td height="25">
