	...
	<head>
	    ...
	    $(function(){
   		...
   		function initListInfo(praData) {
		    ...
		    praData["infoId"]=$("#infoId").val();
		    praData["status"] = $("#status").val();
	   		$.shovePost("queryInfoContent.do",praData,initCallBack);
   		}
   		
   		//删除单个
   		function deleteInfoContentById(adminIds,pageNow){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteInfoContent.do?id="+adminIds+"&pageNow="+pageNow;
	 		}
   		}
   		...
   		//删除多个选中项
   		function deleteInfoContents(pageNow){
   			if(!checked("删除")){
   				return;
   			}
			...
			Ids = Ids.substring(0,Ids.lastIndexOf(","));
		 	window.location.href = "deleteInfoContent.do?id="+Ids+"&pageNow="+pageNow;
   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryInfoContentInit.do">底部信息列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
								<td width="100" align="center" bgcolor="#8594A9" class="white12">
									<a href="addInfoContentInit.do">添加底部信息</a>
								</td>
							<td>
								&nbsp;
							</td>
							...
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									<s:select name="paramMap.infoId" id="infoId" theme="simple"
										list="infoList" listKey="id" listValue="name" headerKey="-1" headerValue="-请选择-">
									</s:select>&nbsp;&nbsp;
									是否显示:
