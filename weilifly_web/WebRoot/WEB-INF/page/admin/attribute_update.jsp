...
<html>
				...
				if(productIds!="-1"){
					...
					if(length>0){
						for(var i = 0 ; i< length;i++){
							$(".productIds").each( function(j, n){
								if(products[i]==n.value){
									n.checked=true;
									return false;
								}
							});
	...
	<body>
		<form id="addAdmin" action="updateAttribute.do" method="post">
								...
								<tr>
									...
									<td align="left" class="f66">
										<s:iterator value="productList" var="bean">
											<input type="checkbox" name="productIds" value="${bean.id }" class="productIds" />${bean.name }&nbsp;&nbsp;
										</s:iterator>
