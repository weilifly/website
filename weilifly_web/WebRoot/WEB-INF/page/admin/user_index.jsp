	...
	<head>
	    ...
	    $(function(){
   		...
   		function initListInfo(praData) {
		    ...
		    praData["isDisable"] = $("#isDisable").val();
	   		$.shovePost("queryUserList.do",praData,initCallBack);
   		}
   		
   		//删除单个
   		function deleteUserById(adminIds,pageNow){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteUser.do?id="+adminIds+"&pageNow="+pageNow;
	 		}
   		}
   		...
   		function deleteUsers(pageNow){
			...
			Ids = Ids.substring(0,Ids.lastIndexOf(","));
		 	window.location.href = "deleteUser.do?id="+Ids+"&pageNow="+pageNow;
   		}
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									&nbsp;&nbsp; 是否禁用:
									<s:select name="isDisable" id="isDisable" theme="simple"
										list="#{-1:'-请选择-',1:'启用',2:'禁用'}" value="-1">
									</s:select>
