...
<html>
  ...
  <body>
    <form id="addBanner" action="addBanner.do" method="post">
			<div id="right"
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<span class="require-field"> <s:textfield type="text"
											...
											id="imgPath" name="paramMap.imgPath" />(最佳分辨率 1920x549px)
											<s:fielderror fieldName="paramMap.imgPath"></s:fielderror> </span>
								</td>
							</tr>
							<tr>
								<td style="height: 25px;" align="right" class="blue12">
								...
								<td align="left" class="f66">
									...
									<s:else>
										<img id="pimg" style="width: 150px; height: 150px" />
									</s:else>
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<s:else>
										<img id="fimg" style="width: 150px; height: 150px" />
									</s:else>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.urlTwo" theme="simple"
										cssStyle="width: 350px; height:23px;" />
									<span style="color: red;">*<s:fielderror
