		...
		$(function(){
   		...
   		function initListInfo(praData) {
		    ...
		    praData["status"] = $("#status").val();
	   		$.shovePost("queryDesign.do",praData,initCallBack);
   		}
   		
   		//删除单个
   		function deleteDesignById(adminIds,pageNow){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteDesign.do?id="+adminIds+"&pageNow="+pageNow;
	 		}
   		}
   		...
   		function deleteDesign(pageNow){
			...
			Ids = Ids.substring(0,Ids.lastIndexOf(","));
		 	window.location.href = "deleteDesign.do?id="+Ids+"&pageNow="+pageNow;
   		}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addDesignInit.do">添加设计素材</a>
							</td>
							<td>
								&nbsp;
							</td>
