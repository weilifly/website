		...
		<script type="text/javascript">
			...
			$(function(){
				$("#btn_save").click(function(){
					...
					$.shovePost("updateProductCategory.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<textarea id="introduction" rows="20" class="textareash" style="width: 700px; padding:5px;">${paramMap.introduction}</textarea>
								</td>
							</tr>
							<tr>
								<td style="height: 25px;" align="right" class="blue12">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:radio name="paramMap.isShow" id="isShow" theme="simple" 
										list="#{1:'是',2:'否'}"/>
