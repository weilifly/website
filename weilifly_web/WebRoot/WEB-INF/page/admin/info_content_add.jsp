...
<html>
		...
		<script type="text/javascript" language="javascript">
	    	...
	    	$(function(){
				...
				$("#btn_save").click(function(){
					...
					$.shovePost("addInfoContent.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
	...
	<body>
		<form id="addInfoContent" action="addInfoContent.do" method="post">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100" align="center" bgcolor="#CC0000" class="white12">
									<a href="addInfoContentInit.do">添加底部信息类型</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr id="trContent" style="display: none;">
								...
								<td align="left" class="f66">
									<textarea id="content" rows="20" name="content" id="txtcontent"
							...
							<tr id="trLink">
								...
								<td align="left" class="f66">
									<s:textfield id="txtLinkPath" theme="simple"
										cssStyle="width:350px;height:23px"  />
									<span style="color: red;">*<s:fielderror
