...
<html>
  ...
  <body>
    <form id="addSeoPage" action="addSeoPage.do" method="post">
			<div id="right"
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<span style="color: red;">*<s:fielderror
											fieldName="paramMap.seoKeyWord" /> </span>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textarea id="seoDescription" name="paramMap.seoDescription" rows="10"  style="width: 400px; padding:5px;"
										cssClass="textareash" theme="simple"></s:textarea>
									<span style="color: red;">*<s:fielderror
