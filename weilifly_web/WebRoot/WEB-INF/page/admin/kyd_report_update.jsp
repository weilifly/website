		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("#btn_save").click(function(){
					...
					$.shovePost("updateKydReport.do",param,function(data){
						alert(data.error);
						if(data.returnId>0){
							window.location.href = "queryKydReportInit.do";
							return;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" align="center" bgcolor="#8594A9"
									class="white12">
									<a href="queryKydReportInit.do">报道列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" align="center" bgcolor="#CC0000" class="white12">
									<a href="addKydReportInit.do">添加报道</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<textarea id="introduction" rows="20" class="textareash" style="width: 700px; padding:5px;">${paramMap.content}</textarea>
								</td>
							</tr>
							<tr>
								<td style="height: 25px;" align="right" class="blue12">
