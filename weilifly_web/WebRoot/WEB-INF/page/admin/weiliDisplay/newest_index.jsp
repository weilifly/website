		...
		<script type="text/javascript">
			...
			function initListInfo(praData){
				...
				praData["isIndex"] = $("#isIndex").val();
		 		...
		 		$.shovePost("queryNewestInfo.do",praData,initCallBack);
		 	}
			...
			function dels(){
		 	...
		 	function checkAll(e){
   			...
   			function delObjs(ids){
   				$.shovePost("deleteNewest.do",{id:ids},function(data){
   					if(data.msg==1){
   						alert("删除成功！");
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28" align="center" bgcolor="#CC0000"
								class="white12">
								<a href="queryNewestInit.do">最新动态列表</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" align="center" bgcolor="#8594A9" class="white12">
								<a href="addNewestInit.do">添加最新动态</a>
							</td>
							<td>
								&nbsp;
							</td>
