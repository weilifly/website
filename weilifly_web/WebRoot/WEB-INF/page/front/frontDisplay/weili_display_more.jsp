		...
		<div class="content">
			<div class="main-content">
				...
				<div class="pp-info-box">
					<div class="pp-info">
						<a href="weiliDisplayDetail.do?id=${singleRecommendMap.id }&typeId=${paramMap.id}" class="pic"><img src="${singleRecommendMap.image }" />
						</a>
						<div>
						<s:if test="#request.singleRecommendMap != null">
							<p class="title">
								<a href="weiliDisplayDetail.do?id=${singleRecommendMap.id }&typeId=${paramMap.id}">${singleRecommendMap.title }</a><span>${singleRecommendMap.addTime }</span>
								</p>
									<p class="txt">
										<shove:sub value="#request.singleRecommendMap.seoDescription" size="100" suffix="..."/><!--  -->
									</p>
									<a href="weiliDisplayDetail.do?id=${singleRecommendMap.id }&typeId=${paramMap.id}" class="ck-btn">查看详情</a>
						</s:if>
						<s:else>
